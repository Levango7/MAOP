...
export const coreMessages = {
  en: {
    ...
    'coach.evolve.title': 'Self-evolution',
    'coach.evolve.body': 'Switch between the evolution console and its history timeline — MAOP improves its own agents, and you can watch it happen.',
    'action.skip': 'Skip',
    'action.next': 'Next',
    'action.done': 'Done',
  ...
  zh: {
    ...
    'coach.evolve.title': '自我演化',
    'coach.evolve.body': '在演化控制台与历史时间线之间切换 —— MAOP 会自我改进智能体，你可以亲眼看到变化。',
    'action.skip': '跳过',
    'action.next': '下一步',
    'action.done': '完成',
