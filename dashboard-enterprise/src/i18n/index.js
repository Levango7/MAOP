...
export const coreMessages = {
  ...
  zh: {
    ...
    'view.run.tabChat': '对话',
    'nav.control.subtitle': '启动、停止和维护平台服务',
    'nav.chat.subtitle': '与智能体对话并检查会话',
    'nav.agents.subtitle': '已发现和注册的智能体 CLI',
    'nav.memory.subtitle': '三层记忆：工作、短期、长期',
    'nav.evolve.subtitle': '规则驱动的自动调优与变更日志',
    'nav.evolutionHistory.subtitle': '性能驱动的基于规则的自动调优闭环',
    'nav.workflowEditor.subtitle': '以可拖拽 DAG 编排智能体工作流',
    ...
    'nav.vector.subtitle': '向量索引管理：统计、浏览和相似度调试',
    'nav.tools.subtitle': '内置、导入和自定义技能',
    ...
    'nav.editionToEnterprise': '切换到企业版？这将启用 SSO / RBAC / 审计等企业功能。',
    'nav.editionToPersonal': '切换到个人版？企业功能（SSO / RBAC / 审计）将被禁用。',
    ...
    'settings.appearanceSub': '即时应用于整个控制台',
    'settings.edition': '版本',
