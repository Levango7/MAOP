export const messages = {
  en: {
    ...
    'view.tenants.loadFailed': 'Failed to load tenants',
    'view.tenants.createFailed': 'Create failed',
  ...
  zh: {
    ...
    'view.tenants.tenantId': '租户 ID',
    'view.tenants.plan': '套餐',
    'view.tenants.unknown': '未知',
    'view.tenants.activate': '激活',
    'view.tenants.suspend': '停用',
    'view.tenants.noTenants': '暂无租户',
    'view.tenants.noTenantsDesc': '创建租户以隔离资源、智能体与用量配额。',
    'view.tenants.loadError': '无法加载租户列表',
    ...
    'view.tenants.loadFailed': '加载租户失败',
    'view.tenants.createFailed': '创建失败',
    'view.tenants.suspendFailed': '停用失败',
