...
.ak-more { font-size: var(--fs-xs); color: var(--text-muted); }
.ak-muted { color: var(--text-muted); font-size: var(--fs-sm); }
.ak-time { color: var(--text-muted); white-space: nowrap; font-size: var(--fs-sm); }
