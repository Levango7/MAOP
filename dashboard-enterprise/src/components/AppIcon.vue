...
/**
 * AppIcon — a self-contained linear icon set (Lucide path data, vendored to
 * avoid a runtime dependency). Icons inherit `currentColor`, so they follow
 * the surrounding text colour and theme automatically.
 *
 * To add an icon: paste its inner SVG markup (the <path>/<line>/… children)
 * as a value in ICONS below. Do NOT pass user-controlled strings here.
 */
const ICONS = {
  // ── Navigation ───────────────────────────────────────────────
  ...
  send: '<path d="M14.536 21.866 3.375 11.58a2 2 0 0 1 0-2.83l11.16-10.29a1 1 0 0 1 1.71.71v7.23l7.49 4.06a1 1 0 0 1 0 1.74l-7.49 4.06v7.23a1 1 0 0 1-1.71.7Z"/>',
  ...
  scroll: '<path d="M15 12h-5"/><path d="M15 8h-5"/><path d="M19 17V5a2 2 0 0 0-2-2H4"/><path d="M8 21h11a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11"/>',
  ...
  power: '<path d="M12 3v10"/><path d="M19 12a7 7 0 1 1-14 0"/>',
  ...
  // F29 修复: McpTopology.vue 引用的 filter / alert / loader 图标
  ...
  // ── Misc (language / external) ────────────────────────────────
  globe: '<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',
  external: '<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',
  'external-link': '<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',
  'book-open': '<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',
  'file-text': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" x2="16" y1="13" y2="13"/><line x1="8" x2="16" y1="17" y2="17"/>',
  compass: '<path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"/><circle cx="12" cy="12" r="10"/>',
  plug: '<path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"/>',

  // ── Dedup / metric / action icon set ────────────────────────
  // R7 修复: ListPageLayout.vue / McpTopology.vue 引用的 inbox / share2 图标
  inbox: '<path d="M22 12a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2z"/><polyline points="22,6 12,13 2,6"/>',
  ...
  beaker: '<path d="M9 3h6"/><path d="M10 3v6.5L4.5 19a2 2 0 0 0 1.8 3h11.4a2 2 0 0 0 1.8-3L14 9.5V3"/><path d="M7 15h10"/>',
  ...
  // ── Evolution / version control (迭代 C 新增) ──────────────
  'git-branch': '<line x1="6" x2="6" y1="3" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/>',
  'git-compare': '<circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 9v6a3 3 0 0 0 3 3h6"/><path d="M18 15V9a3 3 0 0 0-3-3H9"/>',
