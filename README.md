...
| `core/security/` | 安全子包：认证、授权、加密、密钥管理等安全相关能力 |
...
- [ADR-006](docs/adr/006-sse-removal-sync-architecture.md) — SSE removal + sync architecture (Superseded by ADR-016 — Dual-Edition Architecture)
